...
public class ComputerTest {
    ...
    public void testAddOnePart() {
        Part p = new MotherboardPart("", 0.0);
        Computer c = new Computer();
        c.AddPart(p);
    ...
    public void testAddMoreParts() {
        ...
        for (int i = 0; i < PARTS_COUNT; i++) {
            ...
            c.AddPart(new MotherboardPart("", 0.0));
        }
    ...
    public void testGetOnePartComputerPrice() {
        ...
        c.AddPart(new MotherboardPart("", 10.0));
    ...
    public void testGetMorePartsComputerPrice() {
        ...
        for (int i = 0; i < PARTS_COUNT; i++) {
            c.AddPart(new MotherboardPart("", PART_PRICE));
    ...
    public void testComputerIsComplete() {
        ...
        c.AddPart(new CasingPart("", 0.0, ""));
        c.AddPart(new MotherboardPart("", 0.0));
        c.AddPart(new ProcessorPart("", 0.0, 0.0));
        c.AddPart(new MemoryPart("", 0.0, "",0));
